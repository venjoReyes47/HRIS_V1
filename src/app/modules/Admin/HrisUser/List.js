...
export default function UserList(props) {
    ...
    function CreateModal(props) {
        ...
        const [data, setData] = useState({ password: '123', id: 0 })
                ...
                <DialogContent>
                    <div className="row mb-3">
                        <div className="col">
                            ...
                            <input type="text" className="form-control" id="fullname" name="fullName" value={data.fullName} onChange={handleChange} required />
                        </div>
                        <div className="col">
            ...
            >
                ...
                <DialogContent>
                    <div className="row mb-3">
                        <div className="col">
                            <label htmlFor="firstName" className="form-label">Name</label>
                            <input type="text" className="form-control" id="fullname" name="fullName" defaultValue={position.fullName} onChange={handleChange} required />
                        </div>
                        <div className="col">
                            <label htmlFor="firstName" className="form-label">Username</label>
                            <input type="text" className="form-control" id="username" name="username" defaultValue={position.username} onChange={handleChange} required />
                        </div>
    ...
    const columnPosition = [
        ...
        { id: 'fullName', label: 'Name', align: 'left', withSorting: true, hidden: false, disablePadding: false },
        { id: 'username', label: 'Username', align: 'left', withSorting: true, hidden: false, disablePadding: false },
        ...
        <>
            ...
            <main className="card container">
                <div className="card-header">
                    ...
                    <button onClick={() => { setIsOpenCreate(true) }} className="btn btn-primary float-right">Add User</button>
                </div>
