...
export default function IMTableCredential(props) {
    ...
    const handleSelectAllClick = (event) => {
        ...
        if (event.target.checked) {
            ...
            props.clickHandler(newSelecteds)
    ...
    useEffect(() => {
        if (props.selectedCredentials !== undefined) {
            setSelected(props.selectedCredentials)
        }
    }, [])
