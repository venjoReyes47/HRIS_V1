...
import CreatePayment from '../../../../../app/modules/Admin/Accounting/Cashiering/Create';
...
export default function IMTable(props) {
                                                ...
                                                if (!column.hidden) {
                                                    if (column.id === 'RowCnt') {
                                                        ...
                                                        if (props.tableProps.tableType === 'child') {
                                                            ...
                                                            dataUI = <>
                                                                {/* <Link to={{ pathname: `${props.tableProps.onTypes.DATA_LINK}${row['studentId']}`, data: row }} className="btn btn-xs btn-icon btn-icon-xs btn-warning mr-1">
                                                                    <i className="fa fa-folder text-white"></i>
                                                                </Link> */}
                                                                <Link to={{ pathname: `${props.tableProps.onTypes.CHART_LINK}${row['studentId']}`, data: row }} className="btn btn-xs btn-icon btn-icon-xs btn-info mr-1">
                                                                    <i className="fa fa-list-alt text-white"></i>
                                                                </Link>
                                                                {/* `${props.tableProps.onTypes.UPDATE_LINK}${row[recordId]}` */}


                                                                {props.tableProps.withMoreButton && props.tableProps.childWithMoreButton && <Link to={{ pathname: `${props.tableProps.onTypes.MORE_LINK}${row['studentId']}`, data: row }} className="btn btn-xs btn-icon btn-icon-xs btn-primary mr-1">
                                                                    <i className="fa fa-cash-register text-white"></i>
                                                                </Link>}
                                                                {/* {props.tableProps.withMoreButton && !props.tableProps.childWithMoreButton && <Link to={`${props.tableProps.onTypes.MORE_LINK}${row[recordId]}`} className="btn btn-xs btn-icon btn-icon-xs btn-primary mr-1">
                                                                    <i className="fa fa-list-alt text-white"></i>
                                                                </Link>} */}
